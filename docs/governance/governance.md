---
description: How is the Baseline Protocol governed ?
---
...
**Ratified on March 18, 2020 by the** [**PGB**](../community/community-leaders/#your-project-governance-board)**.**
...
### Bootstrapping Period: <a href="#bootstrapping-period" id="bootstrapping-period"></a>
...
### Steady State Periods: <a href="#steady-state-periods" id="steady-state-periods"></a>
