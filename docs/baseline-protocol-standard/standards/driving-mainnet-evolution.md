...
## Point to Point Messaging <a id="point-to-point-messaging"></a>
...
## Gas Pump Service <a id="gas-pump-service"></a>
...
## Barriers to Enterprise Adoption of Public Blockchain <a id="barriers-to-enterprise-adoption-of-public-blockchain"></a>
