...
* Help prioritize work and develop incentives to get it done by joining the [General Assembly](specifications-steering-committee.md) or becoming a [Core Develope](maintainers.md)r or [TSC](technical-steering-committee.md) Member.
...
The specifications work of the community can be done by anyone, both technical and non-technical contributors. The focus is on finding evidence for a requirement and articulating it in the form below. The [General Assembly](specifications-steering-committee.md) is the coordinating body for this work.
