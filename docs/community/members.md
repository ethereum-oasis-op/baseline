...
**Non-technical contributors**, and in particular those who wish to be on the General Assembly, do not need to submit a pull request. See [General Assembly](specifications-steering-committee.md) for details.
...
2. Get elected to the [Technical Steering Committee](technical-steering-committee.md), accountable for architecture and governance of the core developers;
3. Join the [General Assembly](specifications-steering-committee.md) accountable for proposing, prioritizing, and promoting Baseline Protocol projects.
