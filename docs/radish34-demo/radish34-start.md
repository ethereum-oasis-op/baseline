...
If you’ve read the [Radish34 Explained](radish34.md) section or played with the [user experience demo](demo.md) and now want to build and run the POC yourself, you’re in the right place.  Find the authoritative set-up documentation in the Github repo [here](https://github.com/ethereum-oasis/baseline/blob/master/radish34/README.md). Below is a copy we will keep updated for quick reference.
