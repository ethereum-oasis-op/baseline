...
./ops/await_stack.sh
if [ $1 -eq 0 ] && [ ! -d ./zkp/output/createMSA ]; then
    sleep 5
...
elif [ $1 -eq 1 ] && [ ! -d ./zkp/output/createDummyMSA ]; then
    sleep 5
...
if [ $1 -eq 0 ] && [ ! -d ./zkp/output/createPO ]; then
    sleep 5
...
elif [ $1 -eq 1 ] && [ ! -d ./zkp/output/createDummyPO ]; then
    sleep 5
