...
npm run test
```
** These tests take about 10 to 15 seconds to run **
...
<details> 
  ...
  <p> 
    ...
    PASS  __tests__/Verifier.test.js (6.13s)
      ✓ Should be able to deploy Verifier contract (470ms)
      ✓ Should be able to successfully execute verify transaction (1316ms)
      ✓ Should be able to throw when input to verify function overflows snark scalar bound (118ms)
      ✓ Should be able to throw when proof to verify function overflows prime bound (45ms)

    
    PASS  __tests__/OrgRegistry.test.js
      ✓ Deploy Org Registration (279ms)
      ✓ Should be able to set interfaces for compatibility checks (65ms)
      ✓ Should be able to correctly set the interface id (38ms)
      ✓ Should be able to get 0 count at the beginning (25ms)
      ✓ Should be able to register an org (127ms)
      ✓ Should be able to register an orgs interfaces (51ms)
      ✓ Should be able to get all interface details for an org (26ms)
      ✓ Should be able to retrieve the incremented org count (15ms)
      ✓ Should be able to retrieve registered org details (43ms)
      ✓ Should be able to get registrar info (44ms)
      ✓ Should be able to assign new manager (73ms)
      ✓ Should be able to get registrar info as new manager (68ms)

    
    PASS  __tests__/ERC1820Regisry.test.js
      ERC1820 Registry tests
        ✓ Should be able to set the interface hash (30ms)
        ✓ Should be able to set an implementer address (47ms)
        ✓ Should be able to get the implementer address (20ms)
        ✓ Should be able to remove interface (39ms)
        ✓ Should be able to get the updated implementer address (18ms)
        ✓ Should be able to change manager (40ms)
        ✓ Should be able to get the changed manager (16ms)

    Test Suites: 3 passed, 3 total
    Tests:       23 passed, 23 total
    Snapshots:   0 total
    Time:        10.253s, estimated 11s
    Ran all test suites.
    ``` 
  </p>
</details> 
