...
const generateUOM = overrides => {
  const uom = uoms[getRandomInt(0, uoms.length-1)];
  return ({
    name: uom.name,
    symbol: uom.symbol,
    ...overrides,
...
export const getAmount = () => { return amounts[getRandomInt(0, amounts.length-1)]};
export const getDimension = () => { return lengths[getRandomInt(0, lengths.length-1)]};
export const getWeight = () => { return weights[getRandomInt(0, weights.length-1)]};
export const getArea = () => { return areas[getRandomInt(0, areas.length-1)]};
