...
export class Workstep implements IWorkstep {
    ...
    constructor(name: string, id: string, workgroupId: string) {
        this.name = name;
        this.id = id; //[R217] A workstep MUST have a unique identifier within a BPI.
        this.workgroupId = workgroupId; //[R215] A workstep instance MUST be associated with only one workgroup.
