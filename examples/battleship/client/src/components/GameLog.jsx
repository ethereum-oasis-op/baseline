                            ...
                            case RESULT_EVENT:
                                ...
                                switch(data.verification) {
                                    case 'verifying':
                                        ...
                                        break
                                    case 'valid':
                                        status = <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-check" viewBox="0 0 16 16">
                                        ...
                                        break
                                    case 'invalid':
                                        status = <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-x" viewBox="0 0 16 16">
