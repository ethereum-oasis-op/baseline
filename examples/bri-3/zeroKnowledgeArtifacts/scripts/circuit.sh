...
#Setup
snarkjs groth16 setup zeroKnowledgeArtifacts/circuits/$1/$1.r1cs zeroKnowledgeArtifacts/ptau/pot14_final.ptau zeroKnowledgeArtifacts/circuits/$1/$1_final.zkey
...
snarkjs zkey new zeroKnowledgeArtifacts/circuits/$1/$1.r1cs zeroKnowledgeArtifacts/ptau/pot14_final.ptau zeroKnowledgeArtifacts/circuits/$1/$1_0000.zkey
...
snarkjs zkey verify zeroKnowledgeArtifacts/circuits/$1/$1.r1cs zeroKnowledgeArtifacts/ptau/pot14_final.ptau zeroKnowledgeArtifacts/circuits/$1/$1_0003.zkey
...
snarkjs zkey verify zeroKnowledgeArtifacts/circuits/$1/$1.r1cs zeroKnowledgeArtifacts/ptau/pot14_final.ptau zeroKnowledgeArtifacts/circuits/$1/$1_final.zkey
