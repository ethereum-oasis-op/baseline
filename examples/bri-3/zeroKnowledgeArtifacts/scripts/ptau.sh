...
snarkjs powersoftau new bn128 15 zeroKnowledgeArtifacts/ptau/pot15_0000.ptau -v
...
snarkjs powersoftau contribute zeroKnowledgeArtifacts/ptau/pot15_0000.ptau zeroKnowledgeArtifacts/ptau/pot15_0001.ptau \
    --name="First contribution" -v -e="$(head -n 4096 /dev/urandom | openssl sha1)"
snarkjs powersoftau contribute zeroKnowledgeArtifacts/ptau/pot15_0001.ptau zeroKnowledgeArtifacts/ptau/pot15_0002.ptau \
    --name="Second contribution" -v -e="$(head -n 4096 /dev/urandom | openssl sha1)"
snarkjs powersoftau contribute zeroKnowledgeArtifacts/ptau/pot15_0002.ptau zeroKnowledgeArtifacts/ptau/pot15_0003.ptau \
    --name="Third contribution" -v -e="$(head -n 4096 /dev/urandom | openssl sha1)"

# Verify
snarkjs powersoftau verify zeroKnowledgeArtifacts/ptau/pot15_0003.ptau
...
snarkjs powersoftau beacon zeroKnowledgeArtifacts/ptau/pot15_0003.ptau zeroKnowledgeArtifacts/ptau/pot15_beacon.ptau \
...
snarkjs powersoftau prepare phase2 zeroKnowledgeArtifacts/ptau/pot15_beacon.ptau zeroKnowledgeArtifacts/ptau/pot15_final.ptau -v

# Verify the final ptau file. Creates the file pot15_final.ptau
snarkjs powersoftau verify zeroKnowledgeArtifacts/ptau/pot15_final.ptau
