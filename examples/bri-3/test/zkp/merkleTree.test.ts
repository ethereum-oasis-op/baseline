import { MerkleTree } from "../../src/bri/zkp/components/merkleTree/merkleTree";

describe("Create a Merkle Tree and return a unique root", () => {
	test("Should return the same merkle tree root if the input document is same", () => {
		const document1 = {
		name: "Alice",
		company: "AliceCo",
		}
	...
	test("Should return different merkle tree root if the input document is different", () => {
		const document1 = {
		name: "Alice",
		company: "AliceCo",
		}
