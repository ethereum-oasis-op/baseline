...
#Setup
snarkjs groth16 setup zeroKnowledgeKeys/circuit/$1.r1cs zeroKnowledgeKeys/ptau/pot12_final.ptau zeroKnowledgeKeys/circuit/$1_final.zkey
...
snarkjs zkey new zeroKnowledgeKeys/circuit/$1.r1cs zeroKnowledgeKeys/ptau/pot12_final.ptau zeroKnowledgeKeys/circuit/$1_0000.zkey
...
snarkjs zkey verify zeroKnowledgeKeys/circuit/$1.r1cs zeroKnowledgeKeys/ptau/pot12_final.ptau zeroKnowledgeKeys/circuit/$1_0003.zkey
...
snarkjs zkey verify zeroKnowledgeKeys/circuit/$1.r1cs zeroKnowledgeKeys/ptau/pot12_final.ptau zeroKnowledgeKeys/circuit/$1_final.zkey
