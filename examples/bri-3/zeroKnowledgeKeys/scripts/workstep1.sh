...
# Compile circuits
circom src/bri/zeroKnowledgeProof/services/circuit/snarkjs/workstep1.circom -o zeroKnowledgeKeys/circuit --r1cs --wasm

#Setup
snarkjs groth16 setup zeroKnowledgeKeys/circuit/workstep1.r1cs zeroKnowledgeKeys/ptau/pot12_final.ptau zeroKnowledgeKeys/circuit/circuit_final.zkey
...
snarkjs zkey new zeroKnowledgeKeys/circuit/workstep1.r1cs zeroKnowledgeKeys/ptau/pot12_final.ptau zeroKnowledgeKeys/circuit/circuit_0000.zkey
...
snarkjs zkey verify zeroKnowledgeKeys/circuit/workstep1.r1cs zeroKnowledgeKeys/ptau/pot12_final.ptau zeroKnowledgeKeys/circuit/circuit_0003.zkey
...
snarkjs zkey verify zeroKnowledgeKeys/circuit/workstep1.r1cs zeroKnowledgeKeys/ptau/pot12_final.ptau zeroKnowledgeKeys/circuit/circuit_final.zkey
