...
import { BpiMessage } from '../../bri/communication/models/bpiMessage';
...
import { StateTreeLeafValueContent } from '../../bri/state/models/stateTreeLeafValueContent';
import { Transaction } from '../../bri/transactions/models/transaction';
...
export class PrismaMapper {
  ...
  public mapBpiMessagePrismaModelToDomainObject(
    source: BpiMessagePrismaModel,
  ): BpiMessage {
  ...
  public mapBpiAccountPrismaModelToDomainObject(
    source: BpiAccountPrismaModel,
  ): BpiAccount {
  ...
  public mapBpiAccountStateTreeLeafValuePrismaModelToDomainObject(
    source: BpiAccountStateTreeLeafValuePrismaModel,
  ...
  public mapBpiSubjectAccountPrismaModelToDomainObject(
    source: BpiSubjectAccountPrismaModel,
  ): BpiSubjectAccount {
  ...
  public mapTransactionPrismaModelToDomainObject(
    source: TransactionPrismaModel,
  ): Transaction {
  ...
  public mapWorkflowPrismaModelToDomainObject(
    source: WorkflowPrismaModel,
  ): Workflow {
  ...
  public mapWorkgroupPrismaModelToDomainObject(
    source: WorkgroupPrismaModel,
  ): Workgroup {
  ...
  public mapWorkstepPrismaModelToDomainObject(
    source: WorkstepPrismaModel,
  ): Workstep {
