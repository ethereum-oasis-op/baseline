...
export default function CardWorkflowTest() {
  const testWorkflow = async () => {
    ...
    const workflowResp = await axios.post(`${workflowMgrUrl}/workflows?type=test`, {
      description: 'single signature circuit',
      clientType: 'internal test',
      chainId: '101010',
      identities: ['0xa3e05564886b8dbc8667749570af4ac1e3cd60f8731ee7bc31c8fef253e21a2e']
    });
    Alert('success', 'New Workflow created...', `${workflowResp.data.workflowId}`);
  };
    ...
    <>
      <div className="relative flex flex-col min-w-0 break-words w-full mb-6 shadow-lg rounded-lg bg-gray-200 border-0">
        ...
        <div className="flex-auto px-4 lg:px-10 py-10 pt-0">
          <form>
            <h6 className="text-gray-500 text-sm mt-3 mb-6 font-bold uppercase">Steps</h6>
            <div>
              ...
              <br />
              [2] Deploy a test Verifier smart contract.
              <br />
              [3] Deploy a test Shield smart contract.
              <br />
              [4] Setup tracking of events emitted by the Shield smart contract.
              <br />
              <br />A new workflow is created from this process. Check the progress of this sequence and
              troubleshoot any errors by inspecting the workflow.
            </div>
