...
class BaselineWorkgroupManager {
   ...
   * @param {ethers.Contract} orgRegistryContract - instance of the OrgRegistry
   *     contract, connected to the administrator wallet
   * @param {ethers.Contract} verifierContract - instance of the Verifier
   *     contract, connected to the administrator wallet
   * @param {ethers.Contract} shieldContract - instance of the Shield contract,
   *     connected to the administrator wallet
   */
   ...
   * Registers an organisation with the given params into the workgroup
   * organisation registry
   *
   * @param {address} organisationAddress - Address of the registered
   *     organisation
   * @param {string} organisationName - Name of the registered organisation
   * @param {string} organisationMessagingEndpoint - NATS endpoint of the
   *     registered organisation
   * @param {string} organisationWhisperKey - Whisper messaging key to interact
   *     with the registered organisation
   * @param {string} organisationZkpPublicKey - Zero Knowledge Proofs public key
   *     of the registered organisation
   * @param {object} organisationMetadata - Arbitrary metadata to associate with
   *     the registered organization
   * @param {object} transactionOverrides - ethers transaction overrides object
   ...
   * @param {address} shieldAddress The address for the shield contract of the
   *     group
   * @param {address} verifierAddress The address for the verifier contract of
   *     the group
   * @param {object} transactionOverrides - ethers transaction overrides object
   *     to be applied to the transaction
   * @returns ethers.TransactionReceipt object
  ...
  /**
   * Returns the registered information about an organisation with the given
   * organisationAddress
   *
   * @param {address} organisationAddress - the address of the searched
   *     organisation
...
Organisation metadata: ${this.metadata}`;
   ...
   *
   * @param {*} vk - verification key. Probably resolved by verification key
   *     resolver
   * @param {*} actionType - circuit action type that you are registering the
