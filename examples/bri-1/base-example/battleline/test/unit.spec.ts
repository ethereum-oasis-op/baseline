        ...
        describe('Setup', () => {
          describe('Bob', () => {
            ...
            it('should generate a board', async () => {
              ...
              expect(bobBoardInstance.properties.boats.length).to.equal(0);
            ...
            it('should place a boat in the board in a specific location', async () => {
              ...
              expect(bobBoardInstance.properties.boats.length).to.equal(1);
            ...
            it('should randomly place a boat in the board', async () => {
              ...
              expect(bobBoardInstance.properties.boats.length).to.equal(2);
            });
            ...
            describe('baseline', () => {
              it('should generate and verify the proofs to set up a veriafibly equal game', async () => {
                //set up all the proves set out in the baselineSetUp
              });
              it('should set up the in game logic proofs', async () => {
                //set up all the proves set out in the gridProofs
              });
            })
          })
          ...
          describe('Alice', () => {
            it('should generate a board', async () => {
              ...
              expect(aliceBoardInstance.properties.boats.length).to.equal(0);
            ...
            it('should place a boat in the board in a specific location', async () => {
              ...
              expect(aliceBoardInstance.properties.boats.length).to.equal(1);
