...
describe('Baseline', () => {
  ...
  before(async () => {
    ...
    console.log('before BobUserToken')
    ...
    console.log('before aliceApp baselineAppFactory')
    ...
    console.log('before  bobApp baselineAppFactory')
    ...
    console.log('before bobApp')
    await bobApp.init();
    console.log('before aliceApp')
    await aliceApp.init();
  });
