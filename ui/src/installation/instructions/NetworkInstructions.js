...
const NetworkInstructions = () => {
  return (
    <div>
      <h2>Welcome to Radish34</h2>
      <p>
        Before you connect to the thousands of companies on the Radish Registry, we first need to
        connect you to an Ethereum Network and collect some information about your organization.
      </p>
      <p>Please follow the steps to connect to the Radish Registry.</p>
      <Divider />
      <h2>Why do I need to connect to an Ethereum Network?</h2>
      <p>
